...
public interface GeoIPServiceSoap {
    ...
    public GetCountryISO2ByName getIpLocation(
    ...
    public GetCountryISO2ByName getCountryISO2ByName(
    ...
    public GetCountryISO2ByName getIpLocation20(
        @WebParam(name = "sIp", targetNamespace = "http://lavasoft.com/")
        String sIp
    );
}
